  ...
  methods: {
    ...
    getFallbackImagePath(note) {
      try {
        ...
        const remoteUrl = `https://music-1253799806.cos.ap-guangzhou.myqcloud.com/pic_v2/${encodeURIComponent(fileName)}`
    ...
    getPositionDescription(noteName, clef) {
      if (clef === 'treble') {
        ...
        const bassPositions = {
          ...
          'C2': '下加2线',     // C2对应下加2线
          'D2': '下加2间',     // 修正位置
          'E2': '下加1线',     // E2对应下加1线（下加线）
          'F2': '下加1间',     // 修正位置
          // 五线谱主体区域 (标准低音符号位置) - 从G2开始
          'G2': '第1线',       // 低音谱表第1线 = G2
          'A2': '第1间',
          'B2': '第2线',
          'C3': '第2间',       // 标准：低音谱表第二间 = C3
          'D3': '第3线',       // 标准：低音谱表第3线 = D3
          'E3': '第3间',
          'F3': '第4线',
          'G3': '第4间',
          'A3': '第5线',
